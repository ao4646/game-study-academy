...
export function generateMetadata(): Metadata {
  return {
    title: 'ナイトレイン キャラ別解説 - Game Study Academy',
    description: 'エルデンリング：ナイトレインのキャラクター解説記事一覧。各夜渡りの性能と使い方をYouTube動画から学んで効率的にマスターしよう。',
    keywords: [
      'ナイトレイン',
      'Nightreign',
      'キャラクター',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/games/nightreign/character-guide',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Game Study Academy - ナイトレインキャラ別解説',
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://game-study-academy.com/games/nightreign/character-guide',
    },
  }
}
...
export default async function CharacterGuidePage() {
  ...
  const breadcrumbItems = [
    ...
    { name: 'キャラ別解説', url: 'https://game-study-academy.com/games/nightreign/character-guide' }
  ]
