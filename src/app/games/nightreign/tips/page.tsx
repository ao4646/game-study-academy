...
// 小ネタ・裏技記事取得関数
async function getTipsArticles(): Promise<ArticleWithRelations[]> {
  try {
...
export function generateMetadata(): Metadata {
  return {
    title: 'ナイトレイン 小ネタ・裏技集 - Game Study Academy',
    description: 'エルデンリング：ナイトレインの小ネタ・裏技記事一覧。知って得する隠し要素とテクニック情報を詳しく解説します。',
    keywords: [
      'ナイトレイン',
      'Nightreign',
      '小ネタ',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/games/nightreign/tips',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Game Study Academy - ナイトレイン小ネタ・裏技集',
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://game-study-academy.com/games/nightreign/tips',
    },
  }
}
...
export default async function TipsPage() {
  ...
  const breadcrumbItems = [
    ...
    { name: '小ネタ・裏技', url: 'https://game-study-academy.com/games/nightreign/tips' }
  ]
