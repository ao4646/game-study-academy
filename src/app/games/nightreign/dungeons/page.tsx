...
// 地変攻略記事取得関数
async function getDungeonsArticles(): Promise<ArticleWithRelations[]> {
  try {
...
export function generateMetadata(): Metadata {
  return {
    title: 'ナイトレイン 地変攻略ガイド - Game Study Academy',
    description: 'エルデンリング：ナイトレインの地変・ダンジョン攻略記事一覧。効率的なダンジョン攻略法と立ち回りを詳しく解説します。',
    keywords: [
      'ナイトレイン',
      'Nightreign',
      '地変攻略',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/games/nightreign/dungeons',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Game Study Academy - ナイトレイン地変攻略ガイド',
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://game-study-academy.com/games/nightreign/dungeons',
    },
  }
}
...
export default async function DungeonsPage() {
  ...
  const breadcrumbItems = [
    ...
    { name: '地変攻略', url: 'https://game-study-academy.com/games/nightreign/dungeons' }
  ]
