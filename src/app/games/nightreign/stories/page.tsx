...
// 追憶関連記事取得関数
async function getStoriesArticles(): Promise<ArticleWithRelations[]> {
  try {
...
export function generateMetadata(): Metadata {
  return {
    title: 'ナイトレイン 追憶関連 - Game Study Academy',
    description: 'エルデンリング：ナイトレインの追憶関連記事一覧。追憶攻略まとめと見る追憶の内容解説を詳しく解説します。',
    keywords: [
      'ナイトレイン',
      'Nightreign',
      '追憶関連',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/games/nightreign/stories',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Game Study Academy - ナイトレイン追憶関連',
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://game-study-academy.com/games/nightreign/stories',
    },
  }
}
...
export default async function StoriesPage() {
  ...
  const breadcrumbItems = [
    ...
    { name: '追憶関連', url: 'https://game-study-academy.com/games/nightreign/stories' }
  ]
