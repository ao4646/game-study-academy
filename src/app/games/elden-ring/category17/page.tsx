...
async function getCategoryArticles(): Promise<ArticleWithRelations[]> {
  try {
    const { data: articleCategoryRelations, error: articlesError } = await supabase
      ...
      `)
      .eq('category_id', 17) // 戦技・遺灰関連(DLC含む)カテゴリ
...
export function generateMetadata(): Metadata {
  return {
    title: 'エルデンリング 戦技・遺灰関連(DLC含む) 記事一覧 - Game Study Academy',
    description: 'エルデンリング（Elden Ring）の戦技・遺灰関連記事一覧。DLC含む戦技の使い方、遺灰の効果、おすすめビルド、戦闘テクニックなどの情報を網羅。',
    keywords: [
      'エルデンリング',
      'Elden Ring',
      '戦技',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/games/elden-ring/category17',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Game Study Academy - エルデンリング 戦技・遺灰関連',
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://game-study-academy.com/games/elden-ring/category17',
    },
  }
}
...
function ArticleCard({ data }: { data: ArticleWithRelations }) {
  ...
  const categoryName = categories.length > 0 ? categories[0].name : '戦技・遺灰関連'
...
// メインコンポーネント
export default async function SkillsAndAshesPage() {
  ...
  const breadcrumbItems = [
    ...
    { name: '戦技・遺灰関連', url: 'https://game-study-academy.com/games/elden-ring/category17' }
  ]
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
                エルデンリング（Elden Ring）の戦技・遺灰関連記事一覧。<br />
                DLC含む戦技の使い方、遺灰の効果、おすすめビルドなど、戦闘を深める情報を提供しています。
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <span className="text-gray-900 font-medium">戦技・遺灰関連</span>
              </li>
            </ol>
          </nav>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {articles.length > 0 ? (
            ...
            <section className="text-center py-16">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">戦技・遺灰関連記事準備中</h2>
              <p className="text-gray-600 mb-8">
                戦技・遺灰関連記事は現在準備中です。<br />
                順次追加予定ですので、お楽しみに！
              </p>
              <Link
                href="/games/elden-ring"
