...
async function getCategoryArticles(): Promise<ArticleWithRelations[]> {
  try {
    const { data: articleCategoryRelations, error: articlesError } = await supabase
      ...
      `)
      .eq('category_id', 16) // 小ネタ・裏技(DLC含む)カテゴリ
...
export function generateMetadata(): Metadata {
  return {
    title: 'エルデンリング 小ネタ・裏技(DLC含む) 記事一覧 - Game Study Academy',
    description: 'エルデンリング（Elden Ring）の小ネタ・裏技記事一覧。DLC含む隠し要素、バグ技、効率化テクニック、知られざる小ネタなど、お得な情報を網羅。',
    keywords: [
      'エルデンリング',
      'Elden Ring',
      '小ネタ',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/games/elden-ring/category16',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Game Study Academy - エルデンリング 小ネタ・裏技',
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://game-study-academy.com/games/elden-ring/category16',
    },
  }
}
...
function ArticleCard({ data }: { data: ArticleWithRelations }) {
  ...
  const categoryName = categories.length > 0 ? categories[0].name : '小ネタ・裏技'
...
export default async function TipsAndTricksPage() {
  ...
  const breadcrumbItems = [
    ...
    { name: '小ネタ・裏技', url: 'https://game-study-academy.com/games/elden-ring/category16' }
  ]
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
                エルデンリング（Elden Ring）の小ネタ・裏技記事一覧。<br />
                DLC含む隠し要素、効率化テクニック、知られざる小ネタなど、お得な情報を提供しています。
              </p>
