...
async function getCategoryArticles(): Promise<ArticleWithRelations[]> {
  try {
    const { data: articleCategoryRelations, error: articlesError } = await supabase
      ...
      `)
      .eq('category_id', 11) // エリア攻略(DLC)カテゴリ
...
export function generateMetadata(): Metadata {
  return {
    title: 'エルデンリング エリア攻略(DLC) 記事一覧 - Game Study Academy',
    description: 'エルデンリング（Elden Ring）のDLCエリア攻略記事一覧。影の地の各エリアの攻略情報、隠しアイテム、ボス攻略など、Shadow of the Erdtreeの情報を網羅。',
    keywords: [
      'エルデンリング',
      'Elden Ring',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/games/elden-ring/category11',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Game Study Academy - エルデンリング エリア攻略(DLC)',
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://game-study-academy.com/games/elden-ring/category11',
    },
  }
}
...
function ArticleCard({ data }: { data: ArticleWithRelations }) {
  ...
  const categoryName = categories.length > 0 ? categories[0].name : 'エリア攻略(DLC)'
...
// メインコンポーネント
export default async function DLCAreaGuidePage() {
  ...
  const breadcrumbItems = [
    ...
    { name: 'エリア攻略(DLC)', url: 'https://game-study-academy.com/games/elden-ring/category11' }
  ]
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
                エルデンリング Shadow of the Erdtree のDLCエリア攻略記事一覧。<br />
                影の地の各エリアの攻略情報、隠しアイテム、ボス攻略などを網羅しています。
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <span className="text-gray-900 font-medium">エリア攻略(DLC)</span>
              </li>
            </ol>
          </nav>
        </div>
          ...
          {articles.length > 0 ? (
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                ⛰️ DLCエリア攻略記事 ({articles.length}件)
              </h2>
            ...
            <section className="text-center py-16">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">DLCエリア攻略記事準備中</h2>
              <p className="text-gray-600 mb-8">
                Shadow of the Erdtree のエリア攻略記事は現在準備中です。<br />
                順次追加予定ですので、お楽しみに！
              </p>
              <Link
                href="/games/elden-ring"
