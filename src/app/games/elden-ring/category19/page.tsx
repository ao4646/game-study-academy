...
export function generateMetadata(): Metadata {
  return {
    title: 'エルデンリング 考察系動画記事一覧 - Game Study Academy',
    description: 'エルデンリング（Elden Ring）の考察系動画記事一覧。ストーリー解説、世界観考察、キャラクター分析、謎解き、裏設定など、深いゲーム理解のための情報を網羅。',
    keywords: [
      'エルデンリング',
      'Elden Ring',
      '考察',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/games/elden-ring/category19',
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Game Study Academy - エルデンリング 考察系動画',
        },
      ],
    },
    twitter: {
    ...
    alternates: {
      canonical: 'https://game-study-academy.com/games/elden-ring/category19',
    },
  }
}
...
function ArticleCard({ data }: { data: ArticleWithRelations }) {
  ...
  const categoryName = categories.length > 0 ? categories[0].name : '考察系動画'
...
// メインコンポーネント
export default async function TheoryAndAnalysisPage() {
  ...
  const breadcrumbItems = [
    ...
    { name: '考察系動画', url: 'https://game-study-academy.com/games/elden-ring/category19' }
  ]
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
                エルデンリング（Elden Ring）の考察系動画記事一覧。<br />
                ストーリー解説、世界観考察、キャラクター分析など、深いゲーム理解のための情報を提供しています。
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-4">
              ...
              <li>
                <span className="text-gray-900 font-medium">考察系動画</span>
              </li>
            </ol>
          </nav>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {articles.length > 0 ? (
            ...
            <section className="text-center py-16">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">考察系動画記事準備中</h2>
