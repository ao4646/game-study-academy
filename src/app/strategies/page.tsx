...
// 戦術記事取得関数
async function getStrategyArticles(): Promise<ArticleWithRelations[]> {
  try {
...
export function generateMetadata(): Metadata {
  return {
    title: 'ナイトレイン 戦術記事一覧 - Game Study Academy',
    description: 'エルデンリング：ナイトレイン（Elden Ring: Nightreign）の戦術記事一覧。ソロ向け、マルチ向けの効果的な戦術とテクニックをYouTube動画から学習できます。',
    keywords: [
      'ナイトレイン',
      'Nightreign',
      '戦術',
    ...
    openGraph: {
      type: 'website',
      locale: 'ja_JP',
      url: 'https://game-study-academy.com/strategies',
      siteName: 'Game Study Academy',
      title: 'ナイトレイン 戦術記事一覧 - Game Study Academy',
      description: 'エルデンリング：ナイトレイン（Elden Ring: Nightreign）の戦術記事一覧。ソロ向け、マルチ向けの効果的な戦術とテクニックをYouTube動画から学習できます。',
    },
    alternates: {
      canonical: 'https://game-study-academy.com/strategies',
    },
  }
}
...
export default async function StrategiesPage() {
  ...
  const breadcrumbItems = [
    ...
    { name: '戦術', url: 'https://game-study-academy.com/strategies' }
  ]
